...
using DAL;
using FuckingProject.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using FuckingProject.Helpers;

namespace FuckingProject.Controllers
{
	...
	public class CustomerController : ControllerBase
	{
		...
		public async Task<string> Email()
		{
			...
			(bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from FuckingProject", message);
